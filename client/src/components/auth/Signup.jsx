        ...
        <div>
            ...
            <div className='flex items-center justify-center max-w-5xl mx-auto'>
                <form onSubmit={submitHandler} className='w-full max-w-md border border-gray-300 rounded-lg p-6 shadow-lg my-10'>
                    ...
                    {
                        loading
                            ? <Button className="w-full py-2 bg-blue-500 text-white rounded-lg flex justify-center items-center"><Loader2 className='mr-2 h-4 w-4 animate-spin' /> Signing up...</Button>
